...
export default function AdminDashboard() {
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            {/* PRODUCT CRUD MODAL */}
            {isProductModalOpen && (
                <div className="fixed inset-0 bg-stone-900/50 backdrop-blur-sm z-50 flex items-start justify-center p-4 pt-16 animate-fade-in overflow-y-auto pb-24 custom-scrollbar" onPaste={(e) => handlePaste(e, false)}>
            ...
            {isCategoryModalOpen && (
                <div className="fixed inset-0 bg-stone-900/50 backdrop-blur-sm z-50 flex items-start justify-center p-4 pt-16 animate-fade-in overflow-y-auto pb-24 custom-scrollbar" onPaste={(e) => handlePaste(e, true)}>
